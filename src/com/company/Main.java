 ...
 * request made
 * to the web server should notify all the registered observers with the
 * WebRequest object.
...
public class Main {
    ...
    public static void main(String[] args) {
         ...
         * Status 403 : user is not authorized to access this content
         */
        WebRequest request1 = new WebRequest("/dashboard", regularUser);
        webServer.getRequest(request1);

        /**
         * Expected output :
         * Status 404 : Page missing
         */
        WebRequest request2 = new WebRequest("/dashboard/nonExistingPage", adminUser);
        webServer.getRequest(request2);

        /**
         * Expected output :
         * Status 200 : Dashboard content here
         */
        WebRequest request3 = new WebRequest("/dashboard", adminUser);
        webServer.getRequest(request3);

        /**
         * Expected output :
         * Status 200 : Home content here
         */
        WebRequest request4 = new WebRequest("/home", regularUser);
        webServer.getRequest(request4);
